...
export const FEATURE_FLAG_REQUEST_ACCESS = t.literal("FEATURE_FLAG_REQUEST_ACCESS");
export type FEATURE_FLAG_REQUEST_ACCESS = t.TypeOf<typeof FEATURE_FLAG_REQUEST_ACCESS>;

export const FEATURE_FLAG_REQUEST_NET_ERROR = t.literal("FEATURE_FLAG_REQUEST_NET_ERROR");
export type FEATURE_FLAG_REQUEST_NET_ERROR = t.TypeOf<typeof FEATURE_FLAG_REQUEST_NET_ERROR>;

export const FEATURE_FLAG_REQUEST_SVR_ERROR = t.literal("FEATURE_FLAG_REQUEST_SVR_ERROR");
export type FEATURE_FLAG_REQUEST_SVR_ERROR = t.TypeOf<typeof FEATURE_FLAG_REQUEST_SVR_ERROR>;

export const FEATURE_FLAG_REQUEST_RESP_ERROR = t.literal("FEATURE_FLAG_REQUEST_RESP_ERROR");
export type FEATURE_FLAG_REQUEST_RESP_ERROR = t.TypeOf<typeof FEATURE_FLAG_REQUEST_RESP_ERROR>;

export const FEATURE_FLAG_REQUEST_SUCCESS = t.literal("FEATURE_FLAG_REQUEST_SUCCESS");
export type FEATURE_FLAG_REQUEST_SUCCESS = t.TypeOf<typeof FEATURE_FLAG_REQUEST_SUCCESS>;