...
describe('ErrorsType enum', () => {
  ...
  it('should have no unexpected values in the ErrorsType enum', () => {
    ...
    const expectedValues = [
      'UNAUTHORIZED', 'CONNECTION', 'SERVER', 'GENERIC_ERROR', 'AUTH_ERROR', 
      'INVALID_DATA', 'TIMEOUT', 'INVALID_CARD', 'CANCELLED_BY_USER', 
      'EXCESSIVE_AMOUNT', 'POLLING_SLOW', 'STATUS_ERROR', 'INVALID_QRCODE', 
      'DONATIONLIST_ERROR', 'ECOMMERCE_ERROR', 'INVALID_DECODE'
    ];
