    ...
    useTranslation: () => ({
      t: (key: string) => {
        ...
        const translations: Record<string, string> = {
            ...
            'paymentCheckPage.modal.cancelBody': 'Are you sure you want to cancel this payment?',
...
describe('CancelPayment', () => {
  it('calls onCancel when cancel button is clicked', () => {
    ...
    render(<CancelPayment open={true} onCancel={onCancel} onSubmit={() => {}} />);
  ...
  it('calls onSubmit when confirm button is clicked', () => {
    ...
    render(<CancelPayment open={true} onCancel={() => {}} onSubmit={onSubmit} />);
