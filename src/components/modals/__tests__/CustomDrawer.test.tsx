...
describe('CustomDrawer Component', () => {
  ...
  it('uses correct anchor based on device size', () => {
    ...
    expect(require('../../../hooks/useSmallDevice').useSmallDevice).toHaveBeenCalled();
    
    // Now test with mobile (useSmallDevice returns true)
    const useSmallDeviceMock = require('../../../hooks/useSmallDevice').useSmallDevice;
    useSmallDeviceMock.mockReturnValue(true);
    ...
    expect(useSmallDeviceMock).toHaveBeenCalled();
  });
