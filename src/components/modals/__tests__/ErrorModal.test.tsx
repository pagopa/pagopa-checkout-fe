...
describe("ErrorModal Component", () => {
  ...
  it("tracks PSP_UNAVAILABLE when the PSP list error modal is closed with empty error", () => {
    renderModal({
      error: "",
      open: false,
  ...
  it("tracks PSP_UNAVAILABLE without payment info when session storage data is missing", () => {
    mockedGetPaymentInfo.mockReturnValueOnce(undefined);
  ...
  it("does not track PSP_UNAVAILABLE when the closed modal has a different errorId", () => {
    renderModal({
      error: "",
      open: false,
      errorId: "anotherErrorId",
    });
