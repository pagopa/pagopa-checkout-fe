      ...
      case 'privacyInfo.privacyDonation':
        return (
          <span data-testid="privacy-donation">
            ...
            <span data-testid="donation-terms-link">{components?.terms}</span> link
          </span>
        );
      case 'privacyInfo.googleDesc':
        return (
          <span data-testid="google-desc">
            ...
            <span data-testid="google-privacy-link">{components?.privacy}</span> and 
            <span data-testid="google-terms-link">{components?.terms}</span> links
          </span>
        );
      default:
...
describe('PrivacyInfo Component', () => {
  it('renders correctly with default props', () => {
    ...
    const privacyLink = screen.getByTestId('privacy-link').querySelector('[data-testid="link-component"]');
    ...
    const termsLink = screen.getByTestId('terms-link').querySelector('[data-testid="link-component"]');
    expect(termsLink).toBeInTheDocument();
    expect(termsLink).toHaveAttribute('href', '/termini-di-servizio');
    
    // Check links in Google description
    const googlePrivacyLink = screen.getByTestId('google-privacy-link').querySelector('[data-testid="link-component"]');
    ...
    const googleTermsLink = screen.getByTestId('google-terms-link').querySelector('[data-testid="link-component"]');
    expect(googleTermsLink).toBeInTheDocument();
    expect(googleTermsLink).toHaveAttribute('href', 'https://policies.google.com/terms');
  ...
  it('renders donation privacy when showDonationPrivacy is true', () => {
    ...
    const textBetween = typographyText!.substring(
    ...
    const donationTermsLink = screen.getByTestId('donation-terms-link').querySelector('[data-testid="link-component"]');
    expect(donationTermsLink).toBeInTheDocument();
    expect(donationTermsLink).toHaveAttribute('href', 'https://www.pagopa.gov.it/it/privacy-policy-donazioni-ucraina/');
