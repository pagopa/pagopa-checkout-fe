...
import { SessionItems, isStateEmpty } from '../../../utils/storage/sessionStorage';
...
describe('Guard Component', () => {
  ...
  test('renders children when session item exists', () => {
  ...
  test('redirects to home when session item is empty', () => {
  ...
  test('works with different session items', () => {
    // Mock isStateEmpty to return false (-> not empty)
    (isStateEmpty as jest.Mock).mockReturnValue(false);
  ...
  test('nested guards work correctly when all items exist', () => {
    // Mock isStateEmpty to return false (-> not empty)
    (isStateEmpty as jest.Mock).mockReturnValue(false);
        ...
        <Routes>
          <Route 
            ...
            element={
              <Guard item={SessionItems.sessionToken}>
                <Guard item={SessionItems.paymentInfo}>
                  <div data-testid="nested-protected-content">Nested Protected Content</div>
                </Guard>
              </Guard>
            } 
          />
  ...
  test('nested guards redirect when inner item is empty', () => {
  ...
  test('nested guards redirect when outer item is empty', () => {
