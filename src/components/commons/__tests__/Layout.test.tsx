...
jest.mock('../Footer', () => ({
  __esModule: true,
  default: ({ fixedPages }: { fixedPages: string[] }) => (
...
describe('Layout Component', () => {
  ...
  const renderWithTheme = (children: React.ReactNode, fixedFooterPages: string[] = []) => {
    return render(
  ...
  it('passes fixedFooterPages to the Footer component', () => {
    ...
    expect(screen.getByTestId('footer')).toHaveTextContent('Footer - page1, page2');
  });
