...
describe("DrawerDetail Component", () => {
  ...
  it("passes payment notices to DrawerCart component", async () => {
    ...
    const firstAccordionButton = accordionButtons.find((button) =>
      button.textContent?.includes("Notice A")
    );
  ...
  it("renders with a single payment notice", () => {
    ...
    const serviceAButtons = accordionButtons.filter((button) =>
      button.textContent?.includes("Notice A")
    );
    ...
    const serviceBButtons = accordionButtons.filter((button) =>
      button.textContent?.includes("Notice B")
    );
