...
describe('FieldContainer', () => {
  ...
  test('renders with undefined body', () => {
  ...
  test('renders with row flexDirection', () => {
  ...
  test('renders with custom titleVariant', () => {
  ...
  test('renders with custom bodyVariant', () => {
  ...
  test('renders with overflowWrapBody set to false', () => {
  ...
  test('renders in loading state with icon', () => {
    const icon = <div data-testid="test-icon">Icon</div>;
  ...
  test('renders with custom tabIndex', () => {
  ...
  test('renders disclaimer only when not loading', () => {
    const disclaimer = <div data-testid="test-disclaimer">Disclaimer</div>;
