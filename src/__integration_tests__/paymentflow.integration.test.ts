...
export const CHECKOUT_URL_AFTER_AUTHORIZATION = `http://localhost:1234/esito`;
const VALID_FISCAL_CODE = "77777777777";
export const EMAIL = "mario.rossi@email.com";
export const VALID_CARD_DATA = {
...
/* VALID_NOTICE_CODE */
export const VALID_NOTICE_CODE = "302016723749670000";
...
export const FAIL_ACTIVATE_502_PPT_WISP_SESSIONE_SCONOSCIUTA = "302016723749670077";
...
export const CANCEL_PAYMENT_KO = "302016723749670059";
